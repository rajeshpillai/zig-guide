...
inside a file, the parser splits that file at exactly that point and reads
what follows as the head of another part. Most of the time that is a parse
error rather than two files, and nothing tells you which it was, because there
