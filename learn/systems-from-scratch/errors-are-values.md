...
The answer separates error handling that works from error handling everybody
agrees is important and nobody does. If ignoring a failure is a keystroke
shorter than handling it, it gets ignored, and the program carries on with a
number that means "this did not happen".
