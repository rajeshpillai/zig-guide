...
at the same place. That is a real question, and not the one you meant. Coming
from a managed language this is the trap to over-learn: **compare contents with
`std.mem.eql`.**
