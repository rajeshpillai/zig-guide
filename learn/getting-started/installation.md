...
The `xxxx+xxxxxxxxx` stands for the build, which changes every night. Take the
current name off the download page and substitute it in both lines; the
commands do not work as written.
