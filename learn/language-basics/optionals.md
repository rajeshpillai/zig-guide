...
Use it where the invariant is local and visible, such as immediately
...
Note that this only applies to pointers. A `?u32` does need a tag byte
...
Sometimes a value that is just "there or not" gets returned as an
