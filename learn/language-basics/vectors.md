...
compile error rather than a different answer. Indexing does work, with a
runtime index as well as a comptime one, and the index is bounds-checked in a
safety build. What you do not get is something you can slice or pass around by
length. When you want that, use an array. When you want lanes, use a vector.
