...
A check against a comptime-known configuration value is not a branch the CPU
predicts. It is a branch that does not exist in the output. So a library can
