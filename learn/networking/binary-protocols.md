...
This is also why the [Byte Order](https://www.ziglang.in/learn/language-basics/integer-rules/) rules
matter more here than anywhere else in a program: inside your process the
...
not a valid tag is undefined behaviour, not a shortcut, and
