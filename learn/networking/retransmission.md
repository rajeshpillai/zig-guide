...
face. In the first, message 3 arrives intact, its *ack* is lost, and the
sender resends a message the receiver already has; in the second the
message whose ack goes missing is 4. The sender cannot tell those two
