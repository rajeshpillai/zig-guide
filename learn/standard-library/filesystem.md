...
buys more than tidiness. A path resolved against an open handle cannot be
changed underneath you between the check and the use, and that gap is the
shape of a whole family of security bugs.
