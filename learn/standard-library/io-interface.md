...
a real thread pool; [Choosing an Io](https://www.ziglang.in/learn/concurrency/choosing-an-io/)
...
chapter sits next to [Allocators](https://www.ziglang.in/learn/standard-library/allocators/). Once
...
The [Concurrency](https://www.ziglang.in/learn/concurrency/async-future-group/) chapter builds on this
with `async` and `Group`, and
[Cancellation](https://www.ziglang.in/learn/concurrency/cancellation/) with stopping a task
