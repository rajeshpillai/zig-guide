...
parent. That bound buys less than it looks like it buys. Indexing past the end
of the framebuffer is caught. Writing into the panel next door is not, because
those pixels are inside the slice.
