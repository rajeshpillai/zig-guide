...
The earlier chapters drew shapes described by maths: a line from an
...
byte above 127 arrives, and any non-ASCII input contains such bytes. The
...
which is exactly one byte. The storage order followed what the hardware read.
