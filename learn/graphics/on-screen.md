...
> The same buffer, handed to X11 through translate-c, and what changes on Wayland.
...
*Opens a window and waits for a keypress, which CI cannot sit through. Compiled and linked against the real libX11 on every run. (`09-graphics.x11-window`)*
