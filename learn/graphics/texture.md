...
pixel. "Perspective correct" names that fix, and it cost more than the
...
the divisor, the wrapping a sampler wants. Both exist, neither is the default,
and the operator that would have quietly chosen for you is gone.
