...
stage has more than twenty "insertion modes" with different rules each. That
is not complexity anybody wanted: it is the cost of specifying, byte by byte, what
