...
in the same process, the way [the TCP recipe](/learn/networking/tcp-echo/)
...
<Playground
  ...
  tryLocally="zig run redis-resp.zig"
/>
...
recipe](/learn/networking/tcp-echo/) connects. The encoding and decoding here
