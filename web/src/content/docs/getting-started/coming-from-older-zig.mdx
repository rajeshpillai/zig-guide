...
seoTitle: "Zig Migration Guide: Writergate, Io and Unmanaged Containers"
seoDescription: "Code written for a tagged release will not build on Zig master. What changed and what it looks like now: buffered writers, Io, and unmanaged containers."
...
0.17](/learn/getting-started/zig-0-17/) covers only the last step, and says
...
→ [Coming from `std.Thread`](/learn/concurrency/coming-from-std-thread/) ·
[Threads](/learn/concurrency/threads/) ·
[Concurrency](/learn/concurrency/async-future-group/)
