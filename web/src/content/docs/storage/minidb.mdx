...
why every database has `EXPLAIN`, and why the two lines this program prints,
...
If you would rather use one of these than build it, [the database
recipes](/learn/how-to/databases/sqlite-basic/) talk to SQLite, Redis and
PostgreSQL from Zig, and the [ORM](/learn/orm/) builds the layer that sits
above them.
