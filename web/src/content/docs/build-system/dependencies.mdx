---
title: Dependencies
seoTitle: "Zig Package Manager: Dependencies in build.zig.zon"
seoDescription: "Zig's package manager is part of the build system. A dependency is a URL and a hash, fetched into a global cache and verified on the way in. No registry."
