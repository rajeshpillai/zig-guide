...
That makes the doc build a check on your interface. Generating docs and finding
a type you meant to keep private, or a helper with no comment sitting in the
public list, is a review of the boundary that would otherwise never happen.
...
This is worth taking seriously as the primary form of documentation rather than
a supplement to it. A prose example in a comment is a claim about how the
