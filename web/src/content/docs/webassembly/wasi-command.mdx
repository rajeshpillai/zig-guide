---
title: "Recipe: A WASI Command"
description: Compile a Zig program to wasm and run it from a shell under any WASI runtime.
section: WebAssembly
order: 85
---
...
<Playground name="08-webassembly.wasi-command" />
