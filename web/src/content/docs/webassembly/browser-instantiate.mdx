---
title: "Recipe: Loading wasm in the Browser"
description: Fetch, instantiate, wire up imports and exports, and let a module call back into JavaScript.
section: WebAssembly
order: 89
---
...
<Playground
  name="08-webassembly.browser-import"
  note="Imports a host `log` function that Node's WASI does not provide, so it is compiled but not run here. The JavaScript below is what runs it in a browser."
/>
