...
[Runtime Safety](/learn/language-basics/runtime-safety/), and the integer
rules in detail are in [Integer Rules](/learn/language-basics/integer-rules/).

Next: [Strings Are Bytes](/learn/systems-from-scratch/strings-are-bytes/),
