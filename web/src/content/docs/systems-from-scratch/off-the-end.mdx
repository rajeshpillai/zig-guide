...
Off](/learn/systems-from-scratch/when-checks-are-off/).
...
pointers](/learn/language-basics/many-item-pointers/).

Next: [When the Checks Are
Off](/learn/systems-from-scratch/when-checks-are-off/), which is the promise
