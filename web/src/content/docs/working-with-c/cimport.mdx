---
title: Importing C
seoTitle: "Zig @cImport: Calling C Without Bindings"
seoDescription: "@cImport parses C headers directly. There is no binding generator and no generated .zig file to maintain. What it translates, and where it gives up."
