...
and writer interface from [Readers and Writers](/standard-library/readers-and-writers/),
...
you none of those three, which [UDP Datagrams](/networking/udp-message/) covers
...
Next: [A TCP Round Trip](/networking/tcp-echo/), which is this plus an accept
loop.
