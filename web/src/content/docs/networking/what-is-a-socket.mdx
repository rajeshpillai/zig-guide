...
Writers](/learn/standard-library/readers-and-writers/), the same one a file
uses.
...
you none of those three, which [UDP Datagrams](/learn/networking/udp-message/)
...
Next: [A TCP Round Trip](/learn/networking/tcp-echo/), which is this plus an
accept loop.
