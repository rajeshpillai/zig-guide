...
is [the TCP round trip](/networking/tcp-echo/).
...
[Threads](/standard-library/threads/) is a page you cannot run here and this
one is.
...
not syntax. [Concurrency](/standard-library/concurrency/) covers the shape in
general.
...
[Cancellation](/standard-library/cancellation/) covers what a handler sees when
...
[text protocol chapter](/networking/text-protocols/) reached from the other
