...
[Threads](/learn/concurrency/threads/) is a page you cannot run here and
this one is.
...
than syntax. [Concurrency](/learn/concurrency/async-future-group/) covers the
shape in general.
...
[Cancellation](/learn/concurrency/cancellation/) covers what a handler
