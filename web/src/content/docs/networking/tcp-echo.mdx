...
- **Structured protocols:** length-prefixed frames work better than line-delimited text for binary data; see [the wire format recipe](/learn/how-to/binary-roundtrip/).
