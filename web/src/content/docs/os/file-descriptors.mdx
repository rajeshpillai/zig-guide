...
description: Everything the operating system hands you to read or write is an integer.
...
<Playground name="14-os.file-descriptors" />
...
[Network Programming](/learn/networking/what-is-a-socket/) are the same
