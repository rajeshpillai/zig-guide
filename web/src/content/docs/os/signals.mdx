---
title: Signals
seoTitle: "Zig Signal Handling: Set a Flag and Return"
seoDescription: "A signal handler runs between two instructions, on a thread you did not choose. Almost nothing is safe to call inside one, so set a flag and come back."
