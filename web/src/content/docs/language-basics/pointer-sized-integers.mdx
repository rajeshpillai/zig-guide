...
seoTitle: "Zig usize and isize: Pointer Sized Integers"
seoDescription: "usize and isize are exactly as wide as a pointer on the target, which is why .len and every slice index uses them. Why they are not another name for u64."
description: usize, isize, and why they are not the same as u64.
section: Language
order: 21
---
