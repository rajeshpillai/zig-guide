---
title: Arrays
seoTitle: "Zig Arrays: Length Is Part of the Type"
seoDescription: "An array is [N]T, and N belongs to the type, so [3]u8 and [4]u8 differ as much as u8 and u16. Arrays are values, and copying one copies every element."
...
[vector](/learn/language-basics/vectors/), and reading it as "every element
...
recipes](/learn/language-basics/array-recipes/), along with grids and tables
