...
Two cookbook recipes put these builtins to work:
[a SIMD dot product](/cookbook/simd-sum/) for arithmetic and
[SIMD byte scanning](/cookbook/simd-scan/) for searching.
