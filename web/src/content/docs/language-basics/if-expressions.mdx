...
seoTitle: "Zig if Expressions: No Truthiness, and No Ternary"
seoDescription: "Zig has no truthy values: if takes a bool, and nothing else converts to one. if is also an expression, which is what stands in for the ternary operator."
