---
title: Switch
seoTitle: "Zig switch: Exhaustive, and No Fallthrough"
seoDescription: "Zig's switch must cover every value, and it never falls through. Ranges, multiple values, else, and switch used as an expression that returns a value."
...
expressions](/learn/language-basics/loops-as-expressions/). The result goes
...
[unions](/learn/language-basics/unions/) and [payload
captures](/learn/language-basics/payload-captures/).
...
[labelled switch](/learn/language-basics/labelled-switch/).
