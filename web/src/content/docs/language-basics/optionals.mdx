...
seoDescription: "A ?T holds either a T or null, and the compiler will not let you touch the value before handling null. orelse, if captures, and unwrapping that cannot slip."
