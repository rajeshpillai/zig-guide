...
description: "The central pattern of a Zig library: take the caller's type, return a richer one."
...
the query builder from the [next page](/learn/orm/query-builder/). Existing members
