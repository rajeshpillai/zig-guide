...
description: Count what the image contains, and the lookup table that fixes it comes straight from the counts. Auto-levels, equalization, and why you apply them to luma.
section: Graphics
order: 130
---
