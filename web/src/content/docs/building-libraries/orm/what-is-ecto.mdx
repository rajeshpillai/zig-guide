...
description: The Elixir design this group borrows from, explained for people who never wrote Elixir.
...
[query builder chapter](/building-libraries/orm/query-builder/), not a
...
[Repo chapter](/building-libraries/orm/repo/) exploits with its
recording driver.

## Where each idea lives in this group

- Schema as declaration: [A Type Function as the Front Door](/building-libraries/orm/schema-to-sql/)
- Query as a value: [A Typed Query Builder](/building-libraries/orm/query-builder/)
- Declared validations: [Validation from Declarations](/building-libraries/orm/validation-rules/)
- Deriving writes from the schema: [Writing Rows](/building-libraries/orm/insert-update/)
- One gateway, faked in tests: [The Repo](/building-libraries/orm/repo/)
- Bracketing user code safely: [Transactions and errdefer](/building-libraries/orm/transactions/)
