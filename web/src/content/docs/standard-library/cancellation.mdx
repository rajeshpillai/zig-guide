...
[structured concurrency](/learn/standard-library/concurrency/) worth the parameter: a
...
`Io.Mutex.lock`, `io.sleep` and [`Io.RwLock.lock`](/learn/standard-library/locks/) all return `Cancelable!void`
