...
a real thread pool; [Choosing an Io](/standard-library/choosing-an-io/) covers
...
next to [Allocators](/standard-library/allocators/): learn the two together
...
The [Concurrency](/standard-library/concurrency/) chapter builds on this with
`Future` and `Group`, and [Cancellation](/standard-library/cancellation/) with
stopping a task once it is running; [Readers and Writers](/standard-library/readers-and-writers/),
[Filesystem](/standard-library/filesystem/), and [Time](/standard-library/time/)
...
the [migration page](/getting-started/coming-from-older-zig/) lists the
specific renames.
