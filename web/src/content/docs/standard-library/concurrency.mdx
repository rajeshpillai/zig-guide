...
chapter](/learn/standard-library/cancellation/).
...
[Queues](/learn/standard-library/queues/) for tasks that hand work to each
other. [Select](/learn/standard-library/select/) for whichever finishes first.
[Locks](/learn/standard-library/locks/) for the shared state underneath. And
[Choosing an Io](/learn/standard-library/choosing-an-io/) for where the
