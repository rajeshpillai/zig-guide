...
[next chapter](/standard-library/cancellation/).
...
The rest of the machinery follows from here: [Queues](/standard-library/queues/)
for tasks that hand work to each other, [Select](/standard-library/select/) for
whichever finishes first, [Locks and Semaphores](/standard-library/locks/) for
the shared state underneath, and [Choosing an Io](/standard-library/choosing-an-io/)
