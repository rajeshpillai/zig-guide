...
seoTitle: "Zig Game Loop: Fixed Timestep, Accumulator, and No dt"
description: A fixed timestep, an accumulator, interpolation for the leftover, and the split needed for the browser build.
section: Lane Dodger
order: 40
---
