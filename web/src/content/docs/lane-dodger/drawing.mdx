---
title: Drawing It
seoTitle: "Drawing with raylib in Zig: Field Units, the Road and Particles"
description: Field units mapped onto a window, the road, the entities, and a particle system that holds no raylib types.
seoDescription: "Drawing a Zig raylib game: mapping field units onto a window, painting the road and the entities, and a particle system that holds no raylib types so it stays testable."
section: Lane Dodger
order: 60
---
...
[loop](/learn/lane-dodger/the-loop/) hands down. Without that the game visibly
...
[the previous chapter](/learn/lane-dodger/the-world/) described. It costs three
...
It uses the same [pool](/learn/lane-dodger/entities/) the entities use, with a
