...
This is not a complaint about either project. They track releases; this guide
tracks master. It is what happens when a repository following master depends on
someone else's build script.
...
approach: when raylib changes its configuration, this has to follow. It is forty
lines, it is visible, and it fails loudly. The alternative failed invisibly, on
