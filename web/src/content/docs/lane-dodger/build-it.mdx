...
seoTitle: "Build a raylib Game in Zig From Scratch: The File Order"
description: The order to write the files in, the two points where you can stop and check, and what to do when it does not build.
section: Lane Dodger
order: 100
---

import GameSource from "../../../components/GameSource.astro";
import GameFiles from "../../../components/GameFiles.astro";
...
[Vendoring raylib](/learn/lane-dodger/the-build/) explains why.
...
[the tests](/learn/lane-dodger/fair-by-design/) will tell you when you have gone
under it.
